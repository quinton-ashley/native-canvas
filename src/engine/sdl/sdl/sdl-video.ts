...
loadLibrary({
    ...
    SDL_GetWindowProperties: [voit_ptr, [SDL_Window_ptr, string]],
    ...
    SDL_GetWindowSizeInPixels: [voit, [SDL_Window_ptr, int32_ptr, int32_ptr]],
